...
import com.sample.api.exception.ErrorResponse;
import com.sample.api.exception.StudentNotEnrolledException;
...
public class ApplicationExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    @ExceptionHandler({CourseNotFoundException.class, StudentNotFoundException.class, StudentNotEnrolledException.class,TeacherNotFoundException.class})
